...
public class AppConstants {
    ...
    public static String MOBILE_NO_ALREADY_EXISTS = "Mobile number already exists.";
    public static String CREATED_SUCCESSFULLY = "Account Created Successfully.";
    public static String NO_CONTENT = "No content.";
    public static String USER_NOT_FOUND = "User no found.";
    ...
    public static String PAN_NO_ALREADY_EXISTS = "PAN number already exists.";
    public static String GST_NO_ALREADY_EXISTS = "Gst number already exists.";
